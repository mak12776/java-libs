package libs.pxld.examples.animations;

import libs.pxld.Animation;
...
{	
	...
	public void start()
	{
		...
		{
			circles[i] = new Circle(image.xRandom(), image.yRandom(), 
					Random.doubleRange(-5.0, 5.0), Random.doubleRange(-5.0, 5.0),
					0, 0);
		}
