...
public class View implements Picture
{
	...
	{
		for (int y = yStart * xWidth, yEnd2 = yEnd * xWidth, yIndex = 0; y < yEnd2; y += xWidth, yIndex += 1)
		{
			for (int x = xStart * colorWidth, xEnd2 = xEnd
					* colorWidth, xIndex = 0; x < xEnd2; x += colorWidth, xIndex += 1)
			{
